Vagrant.configure("2") do |config|
  ...
  config.vm.define :local do |box|
    box.vm.hostname = "local.belugaseo.com"

    # Static IP for testing.
    box.vm.network :private_network, ip: "192.168.222.48"
    box.vm.network :forwarded_port, guest: 22, host: 2248, auto_correct: true
